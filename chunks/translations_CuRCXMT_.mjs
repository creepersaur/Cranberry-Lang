...
import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, p as renderUniqueStylesheet, q as renderScriptElement, t as createHeadAndContent, r as renderComponent, a as AstroUserError } from './astro/server_mvAWljZZ.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_Dlh3qSIB.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_mfs0oth_.mjs');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_DnBUgCn3.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_l5Hn68_h.mjs');
...
const starlightConfig = {"logo":{"src":"./src/assets/Cranberry_highres.svg","alt":"","replacesTitle":false},"social":[{"icon":"github","label":"GitHub","href":"https://github.com/creepersaur/cranberry-lang"}],"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"Getting Started","translations":{},"collapsed":false,"items":[{"label":"Installation","translations":{},"slug":"getting_started/example","attrs":{}},{"label":"First Project","translations":{},"slug":"getting_started/example","attrs":{}},{"label":"Hello Cranberry","translations":{},"slug":"getting_started/example","attrs":{}}]},{"label":"Basic Topics","translations":{},"collapsed":false,"items":[{"translations":{},"slug":"basic_topics/syntax_overview","attrs":{}},{"translations":{},"slug":"basic_topics/variables","attrs":{}},{"translations":{},"slug":"basic_topics/blocks","attrs":{}},{"translations":{},"slug":"basic_topics/if_statements","attrs":{}},{"translations":{},"slug":"basic_topics/loops","attrs":{}},{"translations":{},"slug":"basic_topics/ranges","attrs":{}},{"translations":{},"slug":"basic_topics/functions","attrs":{}}]}],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","credits":false,"pagefind":{"ranking":{"pageLength":0.1,"termFrequency":0.1,"termSaturation":2,"termSimilarity":9}},"title":{"en":"Cranberry"},"isMultilingual":false,"defaultLocale":{"label":"English","lang":"en","dir":"ltr"}};

const project = {"build":{"format":"directory"},"root":"file:///D:/Coding/Cranberry/_CranberryDocs/","srcDir":"file:///D:/Coding/Cranberry/_CranberryDocs/src/","trailingSlash":"ignore"};
